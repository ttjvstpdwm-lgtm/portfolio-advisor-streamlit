...
- The app calculates allocation, IPS drift, estimated income, realized coupons/dividends, tax withholding, advisor diagnostics, suggested actions, market monitoring, and position-level tables.
